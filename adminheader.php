...
<body>
    <header>
    <a class="cta text-light" style="font-size: 23px;"><i class="fa-solid fa-hospital text-light"></i><span>&nbsp;</span><b>Health Care</b></a>
	    <nav>
            <ul class="nav_links">
                <li><b><u class="text-light"><?php  echo ' Welcome ' . $_SESSION['User'].'!'; ?> </u></b></li>
			    <li><a href="adminindex.php"><b>Dashboard</b></a></li>
			    <li><a href="doctors.php"><b>Doctors</b></a></li>
                <li><a href="schedule.php"><b>Schedule</b></a></li>
                <li><a href="appointment.php"><b>Appointment</b></a></li>
                <li><a href="patients.php"><b>Patients</b></a></li>
            </ul>
	    </nav>     
        <a class="cta text-light" href="adminlogout.php"><i class="fa-solid fa-sign-out text-light"></i>
        <b>Logout</b>
        </a>            
    </header>
</body>
