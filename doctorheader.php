...
<body>
    ...
    <a class="cta text-light" style="font-size: 28px;"><i class="fa-solid fa-hospital text-light"></i><span>&nbsp;</span><b>Health Care</b></a>
	    <nav>
            <ul class="nav_links">
                <li><a href="doctorindex.php"><b><u class="text-light"><?php  echo ' Welcome  &nbsp;' . $_SESSION['User'].' !'; ?> </u></b></a></li>
			    <li><a href="myappo.php"><b>My Appointments</b></a></li>
                <li><a href="searchpatient.php"><b>Search Patients</b></a></li>
            </ul>
	    </nav>     
        <a class="cta text-light" href="doctorlogout.php"><i class="fa-solid fa-sign-out text-light"></i>
        <b>Logout</b>
        </a>            
    </header>
</body>
