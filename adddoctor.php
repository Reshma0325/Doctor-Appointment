    ...
    if (isset($_POST['btnSubmit'])){
        ...
        $password = $_POST['txtPassword'];
            ...
            if (mysqli_num_rows($result) == 0) {
                $query = "insert into doctor (firstname, lastname, gender, mobile, specialist, emailid, loginid, password) values('$firstname', '$lastname', '$gender', '$mobile','$specialist', '$emailid', '$loginid', md5('$password'))";
            ...
            <div class="col-sm-6 m-auto">
                <div class="card bg-dark ">
                    <div class="card-title mt-5" style="background:#c6989d;">
                        <h3 class="text-center py-2">Add Doctor</h3>
                    </div>
                    <div class="card-body">
                        <form method="post">
                        ...
                        <label class="text-center text-white">Specialist:</label>
                        <div class="input-group">
                            <div class="input-group-prepend">
                        ...
                        <div class="input-group">
                            ...
                            <button class="btn  mt-3" style="background:#c6989d;" name="btnSubmit">Add Doctor</button>
