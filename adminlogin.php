            ...
            <div class="col-sm-6 m-auto">
                <div class="card bg-dark ">
                    <div class="card-title mt-5" style="background:#c6989d;">
                        <h3 class="text-center py-2" style="color:#050505;">Admin Login</h3>
                    </div>
                    <div class="card-body">
                        <form method="post">
                        <label class="text-center text-white">UserName:</label>
                        <div class="input-group">
                            <div class="input-group-prepend">
                                <span class="input-group-text bg-dark"><i class="fa-solid fa-user text-light"></i></span>
                            </div>
                            <input type="text" class="form-control mb-3"   name="txtUserName" required>
                        </div>
                        ...
                        <div class="input-group">
                            ...
                            <button class="btn  mt-3" style="background:#c6989d;" name="btnSubmit">Login</button>
...
<?php
    if (isset($_POST['btnSubmit'])){
        ...
        if(mysqli_fetch_assoc($result))
        {
            ...
            echo '<script type="text/javascript"> location.replace("adminindex.php");</script>'; 
        }
        else
        { ?>
            <script>
