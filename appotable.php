...
if(isset($_GET['search'])){
    $search = $_GET['search'];
    $sql ="select * from `bookapp` where bookapp.appoid LIKE '%$search%'";
...
if($result){
        while($row=mysqli_fetch_array($result)){
            ...
            <td>
     <a href="viewappotable.php?viewid=<?php echo $appoid ?>" class="edit-btn" title="View Appointment"><i class="fas fa-eye text-dark"></i></a>
      </td>  
            <td>
     <a href="deleteappo.php?deleteid=<?php echo $appoid ?>" class="del-btn" title="Delete appointment"><i class="fas fa-trash text-dark"></i></a>
      </td>                    
          </tr>
