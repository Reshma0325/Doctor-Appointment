            ...
            <div class="col-sm-6 m-auto">
                <div class="card bg-dark ">
                    <div class="card-title mt-5" style="background:#c6989d;">
                        <h3 class="text-center py-2">User Login</h3>
                    </div>
                    <div class="card-body">
                        <form method="post">
                        ...
                        <div class="input-group">
                            ...
                            <button class="btn  mt-3" style="background:#c6989d;" name="btnLogin">SignUp</button>
                            <input type="button" class="btn btn-light mt-3" value="Go Back!" onclick="history.back()">
                            <a href="userregister.php"><button type="button" class="btn text-dark mt-3" style="background:#fe7f9c;">Register Now</button></a>
                        </form>
                    </div>
                </div>
            </div>
...
<?php
    if (isset($_POST['btnLogin'])){
        ...
        $password = $_POST['txtPassword'];
            $query="select * from  users where pid='$loginid' and password = '$password'";
        ...
        { ?>
            <script>
                swal({
                title: "error!",
                text: "Invalid Loginid and Password",
                icon: "error",
            });
            </script>
            <?php }
