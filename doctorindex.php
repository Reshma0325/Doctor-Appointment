...
<br><br>
    <?php 
     $id=$_SESSION['User'];
        $sql="select * from `doctor` where loginid ='".$_SESSION['User']."'";
       ...
       if($result){
        ...
        <div class="row">
            ...
            <div class="card-body"><h4 class="text-center" style="font-family: Times New Roman; font-size: 20px; ">
                        ...
                        <label class="text-center text-white">Id: <?php echo $loginid ?></label>
            </h4>
                    </div>
                    <a href="editdoc.php?updateid=<?php echo $id?>" class="text-center"><button class="btn  mt-3" style="background:#c6989d;font-weight: 500;
